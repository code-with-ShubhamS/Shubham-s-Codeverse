      ...
      <div className="flex p-4 w-[100%]  sm:w-[50%]">
        ...
        <div className="relative group w-full h-full">
          <Safari
            ...
            url={title}
            mode="simple"
            className="size-full transition-transform duration-500 group-hover:scale-105 group-hover:shadow-xl "
          />
        ...
        <div className="flex space-x-4">
          ...
          >
            ...
            >
              <path
                className=""
                d="M12.293 8.293a1 1 0 0 1 1.414 1.414L10.414 13l3.293 3.293a1 1 0 1 1-1.414 1.414L8 14.414l-3.293 3.293a1 1 0 0 1-1.414-1.414L6.586 13 3.293 9.707a1 1 0 0 1 1.414-1.414L8 11.586l3.293-3.293z"
              />
            </svg> */}
          </a>
        </div>
