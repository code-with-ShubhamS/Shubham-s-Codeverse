...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid w-full max-[60rem] grid-cols-3 gap-4",
        className,
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-background dark:[border:5px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className,
    )}
    {...props}
  >
    ...
    <div className="p-4">
      ...
      >
        ...
        >
          {
            href !== null && (<a href={href} className=" text-[#9a9292]">
              {cta}
